...
-(void)modifyUIWithUrl:(NSString *)url
{
    ...
    NSURL *urlStr = [MyControl returnThumbImageURLwithName:url Width:w Height:w];

    [imageView setImageWithURL:urlStr placeholderImage:[UIImage imageNamed:@"water_white.png"]];
}
