 ...
 *8.私信会出现接收到1条消息，但是显示0条新消息。
 ...
 2.引导图。
 3.求口粮弹框的分享 = 详情页分享 = http://release4pet.aidigame.com/index.php?r=social/foodShareApi&img_id=
 宠物主页分享 = 邀请分享 = http://release4pet.aidigame.com/index.php?r=animal/infoShare&aid=
 ...
 *.摸、球球按钮下载不下来，动画图片下载不下来的情况。
 3.宠物主页的照片页加载还是不流畅，一大片白（添加队列，缩略图）。
 ...
 *.送礼物label(CALayer)+0.6M,CoreAnimation 1.4M。
 *.摇一摇coreAnimation增长。
 ***
 2015.2.1
 解决问题：
