...
- (void)createDirectoryForStoragePath
{
	NSFileManager *fileManager = [[[NSFileManager alloc] init] autorelease];
	
	BOOL isDirectory = NO;
	NSArray *directories = [NSArray arrayWithObjects:storagePath,[storagePath stringByAppendingPathComponent:sessionCacheFolder],[storagePath stringByAppendingPathComponent:permanentCacheFolder],nil];
...
- (void)storeResponseForRequest:(ASIHTTPRequest *)request maxAge:(NSTimeInterval)maxAge
{
	...
	[self createDirectoryForStoragePath];
	NSString *headerPath = [self pathToStoreCachedResponseHeadersForRequest:request];
