...
//    UIViewController *rootController = [self.keyWindow rootViewController];
    [self.chatVC presentViewController:self.photoNavigationController animated:YES completion:nil];
//    [[UIApplication sharedApplication].keyWindow addSubview:self.photoNavigationController];
}
