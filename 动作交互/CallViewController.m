...

{
    ...
    DACircularProgressView *recordProgress;
    DACircularProgressView *playProgress;
}
@end
...
- (void)createRecordOne
{
    ...
    recordProgress = [[DACircularProgressView alloc] initWithFrame:RecordImageView.frame];
    recordProgress.roundedCorners = YES;
    recordProgress.progressTintColor = [UIColor colorWithRed:148/255.0 green:209/255.0 blue:242/255.0 alpha:1];
    recordProgress.thicknessRatio = 0.2;
...
- (void)palyAndPauseView
{
    ...
    playProgress = [[DACircularProgressView alloc] initWithFrame:playBGImageView.frame];
    playProgress.roundedCorners = YES;
    playProgress.progressTintColor = [UIColor colorWithRed:148/255.0 green:209/255.0 blue:242/255.0 alpha:1];
    playProgress.thicknessRatio = 0.2;
