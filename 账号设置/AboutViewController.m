...
//    bgImageView = [MyControl createImageViewWithFrame:CGRectMake(0, 0, WIDTH, self.view.frame.size.height) ImageName:@""];
...
{
    navView = [MyControl createViewWithFrame:CGRectMake(0, 0, WIDTH, 64)];
...
-(void)createUI
{
    sv = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 64, WIDTH, self.view.frame.size.height-64)];
    sv.contentSize = CGSizeMake(WIDTH, 568);
    sv.showsVerticalScrollIndicator = NO;
    [self.view addSubview:sv];
    
    UIImageView * logo = [MyControl createImageViewWithFrame:CGRectMake(118, 89-64, 85, 85) ImageName:@"about.png"];
    [sv addSubview:logo];
    
    UILabel * title = [MyControl createLabelWithFrame:CGRectMake(100, 190-64, 120, 20) Font:17 Text:@"宠物星球"];
    title.textColor = [UIColor blackColor];
    title.textAlignment = NSTextAlignmentCenter;
    [sv addSubview:title];
    
    UILabel * version = [MyControl createLabelWithFrame:CGRectMake(100, 220-64, 120, 20) Font:16 Text:[NSString stringWithFormat:@"V%@", [USER objectForKey:@"versionKey"]]];
...
//    }
    ...
    UIButton * sina = [MyControl createButtonWithFrame:CGRectMake(0, 268-64, WIDTH, 47) ImageName:@"" Target:self Action:@selector(sinaClick) Title:@"新浪微博：宠物星球社交应用"];
...
//    sina.showsTouchWhenHighlighted = YES;
    ...
    UIButton * wechat = [MyControl createButtonWithFrame:CGRectMake(0, WIDTH-64, WIDTH, 47) ImageName:@"" Target:self Action:@selector(wechatClick) Title:@"微信号：imengstar"];
...
//    wechat.showsTouchWhenHighlighted = YES;
    ...
    UIButton * permit = [MyControl createButtonWithFrame:CGRectMake(70, 390-64, 180, 20) ImageName:@"" Target:self Action:@selector(permitClick) Title:@"宠物星球软件许可及服务条款"];
    ...
    UILabel * phone = [MyControl createLabelWithFrame:CGRectMake(118/2, 856/2-64, 200, 20) Font:15 Text:@"联系我们："];
    phone.textColor = [UIColor colorWithRed:85/255.0 green:85/255.0 blue:85/255.0 alpha:1];
    [sv addSubview:phone];
    
    UILabel * mail = [MyControl createLabelWithFrame:CGRectMake(118/2, 450-64, 220, 20) Font:12 Text:@"邮箱：contact@imengstar.com"];
...
//    [sv addSubview:fax];
    ...
    UILabel * copyright = [MyControl createLabelWithFrame:CGRectMake(118/2, 470-64, self.view.frame.size.width-118/2, 20) Font:12 Text:@"版权所有：北京市爱迪通信有限责任公司"];
