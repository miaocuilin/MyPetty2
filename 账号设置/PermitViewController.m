...
-(void)createScrollView
{
    ...
    CGSize size = [str sizeWithFont:[UIFont systemFontOfSize:12] constrainedToSize:CGSizeMake(self.view.frame.size.width-20, 2000) lineBreakMode:1];
    sv.contentSize = CGSizeMake(self.view.frame.size.width, 74+size.height+10);
    UILabel * label = [MyControl createLabelWithFrame:CGRectMake(10, 74, self.view.frame.size.width-20, size.height) Font:12 Text:str];
